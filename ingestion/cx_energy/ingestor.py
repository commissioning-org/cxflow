"""
CX Energy Ingestor - Processes and stores data from Power Automate.
"""
...
class CXEnergyIngestor:
    """
    Ingests CX Energy data from Power Automate.
    ...
    def _generate_id(self, item: Any) -> str:
        ...
        if isinstance(item, dict):
            ...
            for key in ("id", "Id", "ID", "_id", "uuid", "guid", "meter_id", "MeterId"):
                if key in item:
                    return str(item[key])
    ...
    def _extract_items(self, data: Any) -> List[Any]:
        ...
        if isinstance(data, dict):
            ...
            for key in ("items", "value", "data", "results", "records", "readings", "meters"):
    ...
    def ingest(
        ...
        logger.info("Starting CX Energy ingestion")
    ...
    def get_stored_items(self) -> List[Dict[str, Any]]:
        """Get all stored items from the CX Energy data."""
        items = []
