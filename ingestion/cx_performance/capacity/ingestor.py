"""
CX Performance Capacity Ingestor - Processes and stores data from Power Automate.
"""
...
class CapacityIngestor:
    """
    Ingests CX Performance Capacity data from Power Automate.
    ...
    def _generate_id(self, item: Any) -> str:
        ...
        if isinstance(item, dict):
            ...
            for key in ("id", "Id", "ID", "_id", "uuid", "guid", "capacity_id", "CapacityId"):
                if key in item:
                    return str(item[key])
    ...
    def _extract_items(self, data: Any) -> List[Any]:
        ...
        if isinstance(data, dict):
            ...
            for key in ("items", "value", "data", "results", "records", "capacity", "capacities"):
    ...
    def ingest(
        ...
        logger.info("Starting CX Performance Capacity ingestion")
    ...
    def get_stored_items(self) -> List[Dict[str, Any]]:
        """Get all stored items from the capacity data."""
        items = []
